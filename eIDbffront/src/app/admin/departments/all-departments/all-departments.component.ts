...
export class AllDepartmentsComponent implements OnInit, OnDestroy {
  columnDefinitions = [
    ...
    {
      def: 'chefDepartement',
      label: 'Chef du department',
      type: 'text',
      visible: true,
    },
    { def: 'telephone', label: 'Telephone', type: 'phone', visible: true },
    { def: 'mail', label: 'Email', type: 'email', visible: true },
    {
      def: 'titre',
      label: 'Titre du chef du departement',
      type: 'text',
      visible: true,
    },
    {
  ...
  exportExcel() {
    const exportData = this.dataSource.filteredData.map((x) => ({
      ID: x.id,
      'Department Name': x.nom,
      HOD: x.chefDepartement,
      Phone: x.telephone,
      Email: x.mail,
      TITRE:x.titre,
      'Employee Capacity': x.employee_capacity,
      'Established Year': x.establishedYear,
      'Total Employes': x.totalEmploye,
    }));
